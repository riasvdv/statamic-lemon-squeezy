        ...
        Statamic::booted(function () {
            ...
            NavFacade::extend(function (Nav $nav) {
                $nav->item('Lemon Squeezy')
                    ->authorization('lemon squeezy')
                    ->icon('<svg class="fill-current" width="20px" height="18px" viewBox="0 0 128 174" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Permission::extend(function () {
                Permission::register('lemon squeezy')
                    ->label('Manage Lemon Squeezy');
            });
        });
    }
